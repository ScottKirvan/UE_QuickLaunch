...
[Download](https://github.com/ScottKirvan/UE_QuickLaunch/releases) the latest installer release and run it.  The installer runs unassisted, installs into the default Program Files folder, and automatically sets up all the registry keys to handle the File Explorer right-click menus.
