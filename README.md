...
- **CLICK _ON_ A FOLDER**:  You can right-click and select **QuickLaunch** on a folder name, to create or open an unreal project without having to navigate into the folder.  QuickLaunch also ight-click context works on the left side Navigation Pane in File Explorer too, so you can use folders that you've pinned to **Quick access** and your recent history without having to navigate to them.
